...
type WandererResult = GLTF & {
  nodes: { Object_4: THREE.Mesh; Object_6: THREE.Mesh; Object_8: THREE.Mesh; Object_10: THREE.Mesh; Object_12: THREE.Mesh; Object_14: THREE.Mesh }
  materials: Record<string, THREE.Material>
}

export function Wanderer(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/models/wanderer_above_the_sea_of_fog.glb') as unknown as WandererResult
  return (
